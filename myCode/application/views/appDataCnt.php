...
<div id="container">
	...
	<div id="body">
		...
		<?php foreach($sumAmtAAPU as $value){
			echo "<p>".strtoupper($value->username)." : ".$value->sCnt."</p>";
		}
		?>

		<code>Exchange Rates for USD based on Euro : <?php echo $rateArr['usd']; ?></code>
		<code>Exchange Rates for RON based on Euro : <?php echo $rateArr['ron']; ?></code>
	</div>
